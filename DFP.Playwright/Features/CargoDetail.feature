...
Feature: Cargo Details
  ...
  @1931 @INT @login
  Scenario: 1931_CargoDetail_UpdateCD
    Given the transaction "WH" "TC1931" is imported via API
    Given the transaction "PK" "TC1931" is imported via API
    Given I login to Portal as user "with Int"
    Then the login dashboard should be visible
    Given I am on the Cargo Releases page
    Then the Cargo Releases page should be visible
    ...
    Then I should select the country "Algeria" for the CR
    When I click on "Next" button in the Create Cargo Release page
    Then I enter the Warehouse receipt with number "TC1931" in the Available cargo section
    Then I click on "Search" button
    Then I select the item with number "TC1931" in the List in the Available cargo section
    When I click on "Load selected items" button in the Create Cargo Release page step2
    Then the item is loaded with text "UpdateCommodity" in the Create Cargo Release page step2
    When I click on Next button in the Create Cargo Release page step2
    When I click on "Send Cargo Release" button in the Create Cargo Release page step3
    ...
    Then I should see the commodity "UpdateCommodity" in cargo details warehouse
    #-----Verify WH and PK are linked to CR in cargo details page---------
    Then I should verify the WH "TC1931" is linked to CR
    Then I should verify the PK "TC1931" is linked to CR
    When I click on the WH Link "TC1931" in the cargo details page
    Then the warehouse receipt details should be displayed with the name "TC1931"
    When I go to cargo tab
    Then I should see the cargo items page
    Then I should verify the CR "{cr_id}" is linked to WH
    Then I should verify the PK "TC1931" is linked to CR
    When I click on the PK Link "TC1931" in the cargo details page
    Then I should see the pickup order details page with the name "TC1931"
    #---------------MAGAYA STEPS UPDATE COMMODITY FOR THIS TC----------------------
    # Search Commodity in Magaya filter by PK number TC1931 
    # Update the commodity with new description "AUTOMATIONCARGODETAILUPDATED"
    #---------------DFP STEPS to verify the updated Commodity in the Cargo Detail page----------------------
    Given I am on the Cargo Detail page
    Then I should see the Cargo Detail page
    #Verify PK in the portal cargo detail
    Then I search for Parent "Pickup Order" with number "TC1931" in the Cargo Detail page
    Then I click on "Search" button
    Then I should see the search result with the description "AUTOMATIONCARGODETAILUPDATED" and status "Loaded" in the Cargo Detail page
    Then I click on "Reset" button in the Cargo Detail page
    #Verify WH in the portal cargo detail
    Then I search for Parent "Warehouse Receipt" with number "TC1931" in the Cargo Detail page
    Then I click on "Search" button
    Then I should see the search result with the description "AUTOMATIONCARGODETAILUPDATED" and status "Loaded" in the Cargo Detail page
    Then I click on "Reset" button in the Cargo Detail page
    #Verify  CR in the portal cargo detail
    ...
    #Search WH in the Portal and Verify
    Given I navigated to Warehouse Receipts List
    Given I set the warehouse receipt name to "TC1931"
    And I enter the warehouse receipt name in search field
    And I click on Search button
    Then the warehouse receipt should appear in the search results in the List with text "automation"
    #Verify Linked WH PK and CR with updated commodity
    Then I click on the warehouse receipt with number "automation" in the search results list
    Then the warehouse receipt details should be displayed with the name "TC1931"
    When I go to cargo tab
    Then I should see the cargo items page
    Then I should see the commodity "AUTOMATIONCARGODETAILUPDATED" in cargo details warehouse
    Then I should see the quantity is "5000" in the warehouse details page
    Then I should verify the CR "{cr_id}" is linked to WH
    Then I should verify the PK "TC1931" is linked to CR
    When I click on the PK Link "TC1931" in the cargo details page
    Then I should see the pickup order details page with the name "TC1931"
