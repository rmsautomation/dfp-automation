...
#line hidden
                ...
                table28.AddRow(new string[] {
                            ...
                            "GUID"});
#line 58
    await testRunner.AndAsync("I check the following custom field values in the table view:", ((string)(null)), table28, "And ");
#line hidden
            }
            await this.ScenarioCleanupAsync();
        }
...
#line 88
    await testRunner.AndAsync("I should verify the following label headers in warehouse receipt details:", ((string)(null)), table29, "And ");
#line hidden
#line 101
...
#line hidden
                ...
                table31.AddRow(new string[] {
                            ...
                            "automation"});
#line 115
    await testRunner.AndAsync("I should verify the following parties in warehouse receipt details:", ((string)(null)), table31, "And ");
#line hidden
#line 125
...
#line 166
    await testRunner.AndAsync("I should verify the following label headers in warehouse receipt details:", ((string)(null)), table32, "And ");
#line hidden
#line 179
    await testRunner.AndAsync("I should verify custom fields label header \"BooleanCustomField\" contains \"Yes\"", ((string)(null)), ((global::Reqnroll.Table)(null)), "And ");
#line hidden
